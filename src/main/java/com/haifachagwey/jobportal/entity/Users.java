package com.haifachagwey.jobportal.entity;
...
public class Users {
    ...
    //  name = userTypeId (column name inside users table), referencedColumnName = "userTypeId" (column name inside user_type table)
